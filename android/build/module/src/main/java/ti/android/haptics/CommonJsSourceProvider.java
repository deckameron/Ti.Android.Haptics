...
public class CommonJsSourceProvider implements KrollSourceCodeProvider
{
	...
	{
		return getSourceCode("ti.android.haptics");
	}

	public String getSourceCode(String module)
	{
		if (module.equals("${moduleid}/ti.android.haptics")) {
			module = "ti.android.haptics";
		}

		return KrollAssetHelper.readAsset("Resources/ti.android.haptics/" + module + ".js");
	}
}
